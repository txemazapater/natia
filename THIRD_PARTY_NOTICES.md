...
NATIA / NATIA Studio redistributes or will redistribute selected third-party visual assets. Summaries appear below. **Full license texts** are stored under `licenses/`. The machine-readable inventory is `metadata/third-party-assets.json`.

NATIA’s own license remains the root `LICENSE` file and is not replaced by these notices.
...
For contributor guidance see [`docs/legal/third-party-assets.md`](docs/legal/third-party-assets.md) and [`docs/design/`](docs/design/).
